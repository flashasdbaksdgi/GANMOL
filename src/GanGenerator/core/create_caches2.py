...
parser.add_argument(
    "-c", "--col", required=True, type=int, help="Column receptor starts on"
)
parser.add_argument(
    "--recmolcache",
...
parser.add_argument(
    "--ligmolcache", default="lig.molcache2", type=str, help="Filename of ligand cache"
)
parser.add_argument(
    "-d",
    "--data_root",
    type=str,
    required=False,
    help="Root folder for relative paths in train/test files",
    default="",
)
